                ...
                [
                    html.A(
                        dbc.Row(
                            [
                                dbc.Col(
                                    dbc.NavbarBrand(
                                        "World Energy Statistics", className="ms-2"
                                    )
                                ),
                            ],
                            align="center",
                    ...
                    dbc.Collapse(
                        dbc.Nav(
                            [
                                dbc.NavLink(
                                    "Energy Consumption Trends", href="/insight-1"
                                ),
                                dbc.NavLink("The Big Players", href="/insight-2"),
                                dbc.NavLink("Energy Mix", href="/insight-3"),
                                dbc.NavLink("Electricity Mix", href="/insight-4"),
                                dbc.NavLink(
                                    "Energy, GDP and Population", href="/insight-5"
                                ),
                            ],
                            className="ms-auto",
                            navbar=True,
...
def create_homepage():
    return dbc.Container(
        [
            html.H1(
                "Welcome to the World Energy Statistics Dashboard",
                className="text-center mt-4 mb-4",
            ),
            html.P(
                "An Exploration of Global Energy Data.", className="text-center mb-4"
            ),
            dbc.Row(
                [
                    dbc.Col(
                    ...
                    dbc.Col(
                        create_feature_card(
                            "The Big Players", "insight-2", "/assets/big-players.png"
                        ),
                        md=6,
                        lg=4,
                    ),
                    dbc.Col(
                        create_feature_card(
                            "Energy Mix", "insight-3", "/assets/energy-mix.png"
                        ),
                        md=6,
                        lg=4,
                    ),
...
def create_feature_card(title, href, img_src):
    return dbc.Card(
        [
            dbc.CardImg(
                src=img_src, top=True, style={"height": "150px", "objectFit": "cover"}
            ),
            dbc.CardBody(
                [
                ...
                [
                    dbc.Row(
                        dbc.Col(
                            [
                                html.P(
                                    "DS8003 Final Project - Made by Hamna, Ruchi, Amarpreet, Kartikey",
                                    className="text-center mb-2",
                                ),
                                html.P(
                                    children=[
                                        "Data for this project is sourced from the Our World in Data Energy Database, available at ",
                                        html.A(
                                            "OWID Energy Data",
