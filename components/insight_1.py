...
subtext = (
    ...
    "165,000 terawatt-hours (tWH) of primary energy. We see that global energy consumption has ",
    "increased nearly every year for more than 3 decades, with exceptions in 2009 and 2020."
)
